...
export default function CategoriesProductCreateForm(props) {
  const {
    clearOnSuccess = true,
    onSuccess,
    onError,
    ...
    <Grid
      ...
      onSubmit={async (event) => {
        ...
        try {
          ...
          await DataStore.save(new CategoriesProduct(modelFields));
          if (onSuccess) {
      ...
      {...getOverrideProps(overrides, "CategoriesProductCreateForm")}
      {...rest}
    >
      <TextField
        label="Label"
